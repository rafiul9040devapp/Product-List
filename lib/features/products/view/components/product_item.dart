...
class ProductItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      child: GestureDetector(
        ...
        child: ListTile(
          leading: CustomCircularImageView(imageUrl: product.imageUrl ?? '',isHero: true,heroTag: product.id ?? ''),
  ...
  void _navigateToDetailsScreen(BuildContext context) {
    context.navigateTo(routeName: RoutesName.productDetails,arguments: product);
  }
}
